...
function createBoard() {
    ...
    for (let i = 0; i < cardArray, length; i++) {
        ...
        card.setAttribute('src', 'images/doge.png') /* need to change this for my images in future */
...
function checkForMatch() {
    ...
    if (cardsChosen[0] === cardsChosen [1]) {
        ...
        cards[optionOneId].setAttribute('src', 'images/doge.png')
        cards[optionTwoId].setAttribute('src', 'images/doge.png')
